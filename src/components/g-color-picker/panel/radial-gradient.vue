<template>
    <div :class="[`${baseClassName}__gradient`]">
        ...
        <div :class="[`${baseClassName}__gradient-preview`, `${baseClassName}--bg-alpha`]">
            <span class="preview-inner" :style="{ background: color.radialGradient }"></span>
        </div>
    </div>
</template>
<script lang="ts">
...
import {genGradientPoint, gradientColors2string, GradientColorPoint, gradientRadialColors2string} from '../utils';
